                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="companyaddress" type="text" class="form-control @error('companyaddress') is-invalid @enderror" name="companyaddress" value="{{ old('companyname') }}" required autocomplete="companyaddress" autofocus>
