    ...
    <body id="page-top">
        ...
        <form action="" method="post">
            <table id="checkoutTable">
                <tr>
                    <th>Product</th> <th>Product Type</th> <th>Price</th> <th>Quantity</th> <th>Subtotal</th> <th></th>
                </tr>
            ...
            <table id="totalBill">
                ...
                <tr>
                    <td colspan="2" align="center"><input type="submit" value="checkout" id="checkoutBTN"></td>
                </tr>
            </table>
        </form>
    </div>
